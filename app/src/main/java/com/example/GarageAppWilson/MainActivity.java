...
import com.example.GarageAppWilson.Class.myAdapter;
import com.example.GarageAppWilson.Class.myData;
import com.example.GarageAppWilson.Class.myDataModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void SecondApiCall() {
        ...
        secondApiInterface retrofitApi = retrofit.create(secondApiInterface.class);
        Call<JsonArrmodel> call = retrofitApi.getModel();
        call.enqueue(new Callback<JsonArrmodel>() {
            @Override
            public void onResponse(Call<JsonArrmodel> call, Response<JsonArrmodel> response) {
                JsonArrmodel jArray = response.body();
            ...
            @Override
            public void onFailure(Call<JsonArrmodel> call, Throwable t) {
